        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block">Writing Excellence</span>
              <span className="block text-blue-600">Personalized Guidance</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Professional writing tutoring for college students and young professionals.
            </p>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-gray-500">
                ...
                I'm passionate about helping students and professionals enhance their writing skills.
              </p>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg font-medium text-gray-900">Essay Writing</h3>
                <p className="mt-2 text-base text-gray-500">
                  Get help with academic essays, research papers, and analytical writing
                </p>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Assistance with resumes, cover letters, and business communications
                </p>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg font-medium text-gray-900">Writing Skills Development</h3>
                <p className="mt-2 text-base text-gray-500">
                  Learn techniques for better organization, clarity, and style
                </p>
              </div>
            </div>
          </div>
